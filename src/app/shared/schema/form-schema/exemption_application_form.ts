...
export const EXEMPTION_APPLICATION_FORM = {

      title: "APPLICATION FOR EXEMPTION OF INFORMATION FROM THE PUBLIC REGISTER",
      description: "Water Resources Regulations, 2018 - FORM M",
      logoPosition: "right",
      pages: [
        {
          name: "requestPage",
          elements: [
            {
              type: "html",
              name: "requestText",
              html: "<p>I/We* request the Authority, under the provisions of these Regulations, to exclude commercially sensitive information from the public register on waste discharges. The information for exclusion and the reasons for exclusion are described below or on the listed attachments.</p>"
            },
            {
              type: "signaturepad",
          ...
          elements: [
            {
              type: "panel",
              name: "applicantPanel",
              title: "1. Name and address of applicant (or agent for company)",
              elements: [
                {
                  type: "text",
                  name: "fullNames",
                ...
                {
                  type: "text",
                  name: "actingForAddress",
                  title: "Address of the entity you're acting for"
                },
                {
                  type: "text",
                  name: "correspondenceAddress",
                  title: "Address for correspondence if different from above"
                }
              ]
            }
          ]
          ...
          elements: [
            {
              ...
              title: "2. Commercially sensitive information for exclusion from the register",
              description: "Please identify specifically the information, included in the application form for a permit to discharge, which you wish to be excluded from the public register.",
              isRequired: true
            },
            {
              type: "comment",
              name: "exclusionReasons",
              title: "3. Reasons for exclusion of information from the register",
              description: "Please provide clear justification for each item of information you wish to be excluded from the public register. (Note - The onus is on the applicant to justify the exclusion of information. If the Authority is not satisfied that your application is justified he will reject your application.)",
              isRequired: true
            }
          ]
        },
          ...
          elements: [
            {
              ...
              title: "4. Attachments",
              description: "Please attach all information, relevant to this application, to this form.",
            ...
            },
            {
              ...
              description: "List any attachments to this form in the space below."
            },
            {
              type: "checkbox",
              name: "certification",
              ...
              choices: [
                {
                  value: "certify",
                  text: "I/We* certify that the information provided in this form is complete and correct to the best of my/our* knowledge."
                }
              ]
            },
            {
            ...
            },
            {
              type: "html",
              name: "submissionInfo",
              html: "<div style='margin-top: 20px;'><p>When you have completed this form, you should return and you must attach a copy of bank cash deposit slip or cheque for the processing fee and send it to:</p><p>The Executive Director,<br>National Water Resources Authority,<br>Private Bag 363,<br>Lilongwe 3,<br>Telephone: +265 (0) 111 647 907,<br>Email: nwrasec@gmail.com</p></div>"
            }
          ]
        }
      ],
      ...
      completedHtml: "<h3>Thank you for submitting your exemption application</h3><p>The Authority may contact you for further information regarding your application.</p>"
    };
