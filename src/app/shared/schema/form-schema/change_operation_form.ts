...
export const CHANGE_OPERATION_FORM = {

      title: "APPLICATION FOR CHANGE IN OPERATION OR DISCHARGE",
      description: "This form should be used to notify the Authority of any proposed changes in operation or discharge which may be relevant or significant as defined in the regulations.",
      logoPosition: "right",
      pages: [
        {
          name: "page1",
          elements: [
            {
              type: "html",
              name: "intro",
              html: "<p>I/We* notify the Authority of a proposal to modify the operation or discharge currently subject to the existing permit to discharge and request the Authority to determine whether the proposed changes described amount to a significant or relevant change.</p>"
            },
            {
              type: "text",
              name: "permitReferenceNo",
              title: "Existing Permit to Discharge Reference No.",
              isRequired: true
            },
            {
              type: "signaturepad",
              name: "holderSignature",
              title: "Signature of holder",
              isRequired: true
            },
            {
              type: "text",
          ...
          elements: [
            {
              type: "panel",
              name: "holderInfo",
              title: "1. Name and address of holder (or agent for company)",
              elements: [
                {
                  type: "text",
                  name: "fullNames",
          ...
          elements: [
            {
              ...
              title: "2. Proposed changes in operation or discharge",
              description: "Describe the proposed changes in operation (If necessary attach plans and other information to this notice.)",
              isRequired: true
            },
            {
              type: "comment",
              name: "proposedPretreatment",
              title: "3. Proposed pretreatment",
              description: "Give details of any proposed pretreatment or any modifications to the existing system of pretreatment."
            }
          ]
        },
        {
          ...
          elements: [
            {
              type: "panel",
              name: "dischargeRate",
              title: "4. Effect of proposed changes in volume and composition of effluent",
              elements: [
                {
                  type: "panel",
                  name: "dischargeRatePanel",
                  title: "(a) Discharge rate",
                  elements: [
                    {
                      type: "text",
                      name: "existingMaxDaily",
                      title: "Existing maximum daily (m³/day)",
                      isRequired: true,
                      inputType: "number"
                    },
                    {
                      type: "text",
                      name: "proposedMaxDaily",
                      title: "Proposed maximum daily (m³/day)",
                      isRequired: true,
                      inputType: "number"
                    },
                    {
                      type: "text",
                      name: "existingMaxHourly",
                      title: "Existing maximum hourly (litre/sec.)",
                      isRequired: true,
                      inputType: "number"
                    },
                    {
                      type: "text",
                      name: "proposedMaxHourly",
                      title: "Proposed maximum hourly (litre/sec.)",
                      isRequired: true,
                      inputType: "number"
                    }
                  ]
                },
                {
                  ...
                  title: "(b) Composition",
                  description: "Provide details of new raw materials, pollutants, changes in concentration of existing pollutants"
                }
              ]
            }
          ]
