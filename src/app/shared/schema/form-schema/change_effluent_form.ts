...
export const CHANGE_EFFLUENT_FORM = {

      title: "NOTIFICATION OF TRANSFER OF PERMIT TO DISCHARGE EFFLUENT",
      description: "This form should be used to register the transfer of a permit to discharge for an existing discharge to the new owner of the operation to which it applies.",
      logoPosition: "right",
      pages: [
        {
          ...
          elements: [
            {
              ...
              html: "<p>I/We* notify the authority that the permit to discharge was transferred to new holder</p>"
            },
            {
              type: "text",
              name: "permitReferenceNo",
              title: "Permit to Discharge Reference No.",
              isRequired: true
            },
            {
              type: "text",
            ...
            {
              type: "signaturepad",
              name: "newHolderSignature",
              title: "Signature of new holder",
              isRequired: true
            },
            {
              type: "text",
        ...
        {
          name: "newHolderDetails",
          elements: [
            {
              type: "panel",
              name: "holderInfoPanel",
              title: "1. Name and address of new holder (or agent for company)",
              elements: [
                {
                  type: "text",
                  name: "fullNames",
          ...
          elements: [
            {
              type: "comment",
              name: "transferReasons",
              title: "2. Reasons for transfer",
              description: "Please give your reasons for transferring this permit to other persons or company.",
              isRequired: true
            },
            {
              type: "html",
              name: "legalNote",
              html: "<div style='color: red; margin-top: 20px;'><strong>Note:</strong> It is an offence under these Regulations to fail to register the transfer of this permit within twenty-one days of the transfer taking place. If you fail to do so you may be subject to a fine or a custodial sentence.</div>"
            }
          ]
        },
        {
          ...
          elements: [
            {
              ...
              name: "attachments",
              title: "Attachments",
              description: "Please attach any supporting documents.",
      ...
      completeText: "Submit Notification",
      widthMode: "responsive",
      showNavigationButtons: "both",
      completedHtml: "<h3>Thank you for submitting your transfer notification</h3><p>Please remember to attach a copy of bank cash deposit slip or cheque for the processing fee and send it to:</p><p>The Executive Director,<br>National Water Resources Authority,<br>Private Bag 363,<br>Lilongwe 3,<br>Telephone: +265 (0) 111 647 907,<br>Email: nwrasec@gmail.com</p>"
    };

    /*const survey = new Survey.Model(surveyJson);

    // Add custom validation for transfer date (must be within last 21 days)
    survey.onValidateQuestion.add((sender, options) => {
      if (options.name === "transferDate") {
        const transferDate = new Date(options.value);
        const today = new Date();
        const diffTime = Math.abs(today.getTime() - transferDate.getTime());
        const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));

        if (diffDays > 21) {
          options.error = "Transfer must be reported within 21 days of the transfer date.";
        }
      }
    });
