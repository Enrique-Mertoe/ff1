...
export const BOREHOLE_REHABILITATION_FORM = {

      title: "APPLICATION FOR PERMISSION TO REHABILITATE DEFECTIVE BOREHOLES",
      description: "Water Resources Regulations, 2018 - FORM B2",
      logoPosition: "right",
      pages: [
        {
          name: "clientDetails",
          ...
          elements: [
            {
              type: "panel",
              name: "boreholePanel",
              title: "2. Details of the borehole",
              elements: [
                {
                  type: "text",
                  name: "licenceNumber",
                  title: "Licence number of the borehole",
                  isRequired: true
                },
                {
                  type: "text",
                  name: "location",
                  title: "Location of the borehole (Coordinates Village/Area, Traditional Authority, Water Resources Area, and District)",
                  isRequired: true
                },
                {
                  type: "text",
                ...
                {
                  type: "text",
                  name: "casingSealingDetails",
                  title: "Amount and location of casing or sealing in the borehole",
                  isRequired: true
                },
                {
                  type: "paneldynamic",
                  name: "strataDetails",
                  title: "Details of the strata",
                  templateElements: [
                    {
                      type: "text",
                      name: "depthInterval",
                    ...
                    {
                      type: "comment",
                      name: "strataDescription",
                      title: "Description of the Strata (include issues of water quality if any)"
                    }
                  ],
                  panelAddText: "Add strata layer",
                  panelRemoveText: "Remove strata layer"
                }
              ]
            }
          ]
          ...
          elements: [
            {
              type: "panel",
              name: "rehabPanel",
              title: "3. Rehabilitation details",
              elements: [
                {
                  type: "comment",
                  name: "rehabilitationMethods",
                  title: "Describe the methods of rehabilitation of the borehole",
                  isRequired: true
                }
              ]
            }
          ...
          elements: [
            {
              ...
              html: "<p>I certify that the information provided in this form is correct to the best of my knowledge. I also agree that no decision will be made pursuant to this application until I receive a notification from the Authority of water development that I have provided all the necessary information.</p>"
            },
            {
              type: "signaturepad",
            ...
            },
            {
              type: "file",
              name: "boreholeReport",
              title: "Attach borehole completion report",
            ...
            },
            {
              type: "html",
              name: "submissionInfo",
              html: "<div style='margin-top: 20px;'><p>Note: When you have completed this form and the appropriate attachments, you must attach a copy of bank cash deposit slip or cheque for the processing fee and send them to:</p><p>The Executive Director,<br>National Water Resources Authority,<br>Private Bag 363,<br>Lilongwe 3,<br>Telephone: +265 (0) 111 647 907,<br>Email: nwrasec@gmail.com</p></div>"
            }
          ]
        }
      ],
      ...
      completedHtml: "<h3>Thank you for submitting your borehole rehabilitation application</h3><p>The Authority will process your application and contact you if additional information is required.</p>"
    };

    /*const survey = new Survey.Model(surveyJson);

    // Add validation for strata details
    survey.onValidateQuestion.add((sender, options) => {
      if (options.name === "strataDetails" && (!options.value || options.value.length === 0)) {
        options.error = "Please provide details of at least one strata layer";
      }
    });
