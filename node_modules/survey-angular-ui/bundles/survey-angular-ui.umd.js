(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var ActionComponent = /** @class */ (function (_super) {
      ...
      ActionComponent.prototype.ngAfterViewInit = function () {
          ...
          this.model.updateModeCallback = function (mode, callback) {
              ...
              queueMicrotask(function () {
                  var _a;
                  callback(mode, (_a = _this.containerRef) === null || _a === void 0 ? void 0 : _a.nativeElement);
              });
          };
  ...
  var ScrollComponent = /** @class */ (function (_super) {
      ...
      function ScrollComponent(viewContainerRef) {
          var _this = _super.call(this, viewContainerRef) || this;
          _this.model = new Survey.ScrollViewModel();
          _this.model.onInnerHeightChanged = function (hasScroll) {
              if (!!_this.onInnerHeightChanged) {
                  _this.onInnerHeightChanged(hasScroll);
              }
          };
          return _this;
      }
  ...
  ScrollComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ScrollComponent, deps: [{ token: i0__namespace.ViewContainerRef }], target: i0__namespace.ɵɵFactoryTarget.Component });
  ScrollComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ScrollComponent, selector: "sv-scroll", inputs: { disabled: "disabled", onInnerHeightChanged: "onInnerHeightChanged" }, viewQueries: [{ propertyName: "container", first: true, predicate: ["container"], descendants: true }], usesInheritance: true, ngImport: i0__namespace, template: "<ng-template #template>\n    <ng-container *ngIf=\"!disabled\">\n        <div class=\"sv-scroll__wrapper\" #container>\n            <div class=\"sv-scroll__scroller sv-drag-target-skipped\" (scroll)=\"model.onScrollContainer()\">\n                <div class=\"sv-scroll__container\">\n                    <ng-container *ngTemplateOutlet=\"transparentTemplate\"></ng-container>\n                </div>\n            </div>\n            <div class=\"sv-scroll__scrollbar\" (scroll)=\"model.onScrollScrollbar()\">\n                <div class=\"sv-scroll__scrollbar-sizer\">\n                </div>\n            </div>\n        </div>\n    </ng-container>\n    <ng-container *ngIf=\"disabled\"><ng-container *ngTemplateOutlet=\"transparentTemplate\"></ng-container></ng-container>\n</ng-template>\n<ng-template #transparentTemplate>\n    <ng-content></ng-content>\n</ng-template>", styles: [":host { display: none; }"], directives: [{ type: i2__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i2__namespace.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet"] }] });
  i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ScrollComponent, decorators: [{
              type: i0.Component,
              args: [{
                      selector: "sv-scroll",
          ...
          }], ctorParameters: function () { return [{ type: i0__namespace.ViewContainerRef }]; }, propDecorators: { disabled: [{
                  type: i0.Input
  ...
  var PopupComponent = /** @class */ (function (_super) {
      ...
      PopupComponent.prototype.onModelChanged = function () {
          ...
          this.model = Survey.createPopupViewModel(this.popupModel);
  ...
  CheckboxItemComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: CheckboxItemComponent, selector: "sv-ng-checkbox-item, '[sv-ng-checkbox-item]'", inputs: { question: "question", model: "model", ariaLabel: "ariaLabel" }, ngImport: i0__namespace, template: "<input type=\"checkbox\" [name]=\"question.name+model.id\" [id]=\"question.getItemId(model)\" [class]=\"question.cssClasses.itemControl\" [required]=\"question.hasRequiredError()\"\n  [disabled]=\"!question.getItemEnabled(model)\" [readonly]=\"question.isReadOnlyAttr\" [checked]=\"question.isItemSelected(model)\" [value]=\"model.value\" (change)=\"onChange($event)\" [attr.aria-label]=\"ariaLabel\"/>\n<ng-content></ng-content>", styles: [""] });
  ...
  var SliderQuestionComponent = /** @class */ (function (_super) {
      __extends(SliderQuestionComponent, _super);
      function SliderQuestionComponent() {
          return _super !== null && _super.apply(this, arguments) || this;
      }
      SliderQuestionComponent.prototype.ngAfterViewInit = function () {
          _super.prototype.ngAfterViewInit.call(this);
          if (this.model && this.rangeInputElement) {
              this.model.refreshInputRange(this.rangeInputElement);
          }
      };
      Object.defineProperty(SliderQuestionComponent.prototype, "rootRef", {
          get: function () {
              var _a;
      ...
      Object.defineProperty(SliderQuestionComponent.prototype, "rangeInputElement", {
          get: function () {
              var _a;
  ...
  var ListItemComponent = /** @class */ (function (_super) {
      ...
      Object.defineProperty(ListItemComponent.prototype, "ariaChecked", {
          get: function () {
      ...
      Object.defineProperty(ListItemComponent.prototype, "itemStyle", {
          get: function () {
  ...
  var ProgressTocComponent = /** @class */ (function (_super) {
      ...
      ProgressTocComponent.prototype.ngAfterViewInit = function () {
  ...
  ProgressTocComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ProgressTocComponent, selector: "sv-navigation-toc, sv-ng-navigation-toc", inputs: { survey: "survey", model: "model" }, usesInheritance: true, usesOnChanges: true, ngImport: i0__namespace, template: "<ng-template #template>\n  <div [class]=\"model.containerCss\">\n    <sv-ng-list *ngIf=\"!model.isMobile\" [model]=\"model.listModel\"></sv-ng-list>\n    <div *ngIf=\"model.isMobile\" (click)=\"model.togglePopup()\" data-bind=\"key2click\">\n        <svg [iconName]=\"model.icon\" [size]=\"24\" sv-ng-svg-icon></svg>\n        <sv-ng-popup [popupModel]=\"model.popupModel\"></sv-ng-popup>\n    </div>\n  </div>  \n</ng-template>", styles: [":host { display: none; }"], components: [{ type: ListComponent, selector: "sv-ng-list, '[sv-ng-list]'", inputs: ["model"] }, { type: SvgIconComponent, selector: "'[sv-ng-svg-icon]'", inputs: ["size", "width", "height", "iconName", "partCss", "css", "title"] }, { type: PopupComponent, selector: "sv-ng-popup, '[sv-ng-popup]'", inputs: ["popupModel"] }], directives: [{ type: i2__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
