...
class BreadcrumbsComponent extends BaseAngular {
    getModel() {
        return this.model;
    }
}
...
class SingleInputSummaryComponent {
...
class SliderQuestionComponent extends QuestionAngular {
    ngAfterViewInit() {
...
ButtonGroupDropdownComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ButtonGroupDropdownComponent, selector: "sv-ng-buttongroup-dropdown-question", inputs: { model: "model" }, ngImport: i0, template: "<div [class]=\"model.cssClasses.rootDropdown\">\n  <sv-ng-dropdown [model]=\"model\"></sv-ng-dropdown>\n</div> ", components: [{ type: DropdownComponent, selector: "sv-ng-dropdown, '[sv-ng-dropdown]'", inputs: ["model"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ButtonGroupDropdownComponent, decorators: [{
            type: Component,
            args: [{
...
class MatrixDynamicPlaceholderComponent {
    addRowClick() {
